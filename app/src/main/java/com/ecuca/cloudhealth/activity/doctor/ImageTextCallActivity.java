...
public class ImageTextCallActivity extends BaseActivity {
    ...
    TextView tvBeGoodAt;
    @BindView(R.id.tv_serive_info)
    TextView tvSeriveInfo;
    ...
    protected void setContentView() {
        order_id=getIntent().getIntExtra("order_id",order_id);
        doctor_id = getIntent().getIntExtra("doctor_id", 0);
        setContentView(R.layout.aty_image_text_call);
    ...
    protected void startFunction() {
        ...
        tvDoCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ImageTextCallActivity.this, DoImageTextCallActivity.class);
                intent.putExtra("doctor_id",doctor_id);
                intent.putExtra("order_id",order_id);
                ImageTextCallActivity.this.startActivity(intent);
                finish();
            }
        });
    ...
    private void setData(CallDoctorDetailsEntity.DataBean bean) {
        ...
        if (bean != null) {
            ...
            tvSeriveInfo.setText(Html.fromHtml(bean.getDescription()==null?"":bean.getDescription()));
