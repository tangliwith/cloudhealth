...
public class DoctorRegistrationInfoActivity extends BaseActivity {
    ...
    protected void setContentView() {
        ...
        setContentView(R.layout.aty_registration_doctor_info);
    ...
    protected void startFunction() {
        ...
        tvRegistrationDoctor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DoctorRegistrationInfoActivity.this, CreateRegisteredOrderActivity.class);
                DoctorRegistrationInfoActivity.this.startActivity(intent);
            }
        });
    }
