...
public class QuickIndexBar extends View {
    ...
    // 默认字体颜色
    private int defaultFontColor = getResources().getColor(R.color.text_gray999);
    // 默认选中字体颜色
    private int defaultSelectedFontColor = getResources().getColor(R.color.text_black);
    // 字体颜色
    ...
    public interface OnIndexChangeListener {
         ...
         * 当索引改变
         *
         * @param selectIndex_str 索引值
         */
        void onIndexChange(String selectIndex_str);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (selected >= 0 && selected < INDEX_ARRAYS.length) {
                    if (selected != lastSelected) {
                        if (listener != null) {
                            listener.onIndexChange(INDEX_ARRAYS[selected]); // 回调监听器的方法
                        }
