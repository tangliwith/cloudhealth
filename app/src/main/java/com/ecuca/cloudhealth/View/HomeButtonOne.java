...
public class HomeButtonOne extends View{
    public HomeButtonOne(Context context) {
        super(context);
    }
    private int defalutSize;
    public HomeButtonOne(Context context, AttributeSet attrs) {
        super(context,attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Path path=new Path();
        path.moveTo(0, 0);//起始点
        path.lineTo(20, 0);//从起始点画一根线到 相应的坐标
        path.lineTo((float) 100 / 2, 2000);
        path.close();//闭合
